          ...
          {activeStep === 1 ? (
            cartItems.map((item) => (
              ...
              >
                ...
                {/* DELETE BUTTON */}
                <button className="w-8 h-8 hover:w-20 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-400 text-red-400 flex items-center justify-center cursor-pointer">
